...
---@return boolean
---@nodiscard
function System.isFile(path) end;
...
---@param mode? boolean режим (false - стандарт [только кнопка О]; true - режим Да/Нет [кнопки Да/Нет]) [по умолчанию: false]
---@param cleanBG? boolean Очищать фон
---@param bgpath? string Путь до фона (480x272)
...
---@return "JP"|"US"|"FR"|"ES"|"DE"|"IT"|"NL"|"PT"|"RU"|"KR"|"TW"|"CN"|string
---@nodiscard
...
---@return string
---@nodiscard
function System.getGameTitle() end;
