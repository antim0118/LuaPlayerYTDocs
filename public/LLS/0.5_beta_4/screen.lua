...
---Устанавливает режим и координаты камеры
---@param use boolean Включает/отключает систему камеры
---@param x? number X координата камеры
---@param y? number Y координата камеры
function screen.setCamera(use, x, y) end;

---Возвращает координаты камеры
---@return number x
---@return number y
---@nodiscard
function screen.getCamera() end;
