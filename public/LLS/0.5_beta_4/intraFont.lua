...
---@param align? intraFontAlignEnum|intraFontAlignNumbers режим выравнивания шрифта
---@return number x Координата X после последней буквы
...
---@param GU_LINEAR? boolean интерполяция текстуры. true=LINEAR, false=NEAREST
---@return number x Координата X после последней буквы
function intraFont.printBackground(x, y, text, textColor, bgColor, font, size, GU_LINEAR) end;
...
---@return number x Координата X после последней буквы
function intraFont.printColumn(x, y, text, width, textColor, font, size, align, GU_LINEAR, scroll) end;
...
---@param GU_LINEAR? boolean интерполяция текстуры. true=LINEAR, false=NEAREST
---@return number x Координата X после последней буквы
function intraFont.printContoured(x, y, text, textColor, contourColor, font, size, rotation, GU_LINEAR) end;
...
---@param GU_LINEAR? boolean интерполяция текстуры. true=LINEAR, false=NEAREST
---@return number x Координата X после последней буквы
function intraFont.printGradient(x, y, text, textColorStart, textColorEnd, font, size, GU_LINEAR) end;
...
---@param GU_LINEAR? boolean интерполяция текстуры. true=LINEAR, false=NEAREST
---@return number x Координата X после последней буквы
function intraFont.printStriked(x, y, text, textColor, lineColor, font, size, GU_LINEAR) end;
...
---@param GU_LINEAR? boolean интерполяция текстуры. true=LINEAR, false=NEAREST
---@return number x Координата X после последней буквы
function intraFont.printShadowed(x, y, text, textColor, shadowColor, font, shadowRotation, lightDistance, size, rotation, GU_LINEAR) end;
...
---@param GU_LINEAR? boolean интерполяция текстуры. true=LINEAR, false=NEAREST
---@return number x Координата X после последней буквы
function intraFont.printUnderlined(x, y, text, textColor, lineColor, font, size, GU_LINEAR) end;
